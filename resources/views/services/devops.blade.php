      ...
      <div class="container">
       <div class="row">
        ...
        <div class="col-lg-8 text-left">
          ...
          <div id="2"></div>
          <h3>Commercial Facing &#38; Enterprise Application Development</h3>
          ...
          <div class="col-lg-12 text-left">
            <img class="devOpsChart" src="/img/FPT-Devops-chart.jpg">
          </div>

          <br>
          
          <div id="3"></div>
          <h3>Mobile Web &#38; Native Mobile Applications</h3>
          ...
          <div id="5"></div>
          <h3>Application Updates, Migration, &#38; Re-Platforming</h3>
          ...
          <p>Our CMS experts take immense pride in creating solutions according to your needs, as well as choosing the right tool for the right need, all while providing the best web and mobile experience together with a social integration.</p>
          ...
          <p>All testing process are defined and planned, considering the project needs and conditions. Planning includes areas such as:</p>
            <ul>
              ...
              <li>Environment requirements for testing</li>
              <li>Creation of the test plan</li>
            </ul>
